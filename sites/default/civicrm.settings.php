...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://bdanza:L3ftoft3d@bdanzageneral.c2bl67bfl9ev.us-east-1.rds.amazonaws.com/bdanza?new_link=true' );
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://bdanza:L3ftoft3d@bdanzageneral.c2bl67bfl9ev.us-east-1.rds.amazonaws.com/bdanza?new_link=true' );
}
...
$civicrm_root = '/home/brian/code/bdanza/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/brian/code/bdanza/sites/default/files/civicrm/templates_c/' );
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://www.bdanza.com/' );
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'e1dd4613fa05ce1b8ddeb7c6ecbf60d4' );
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/bdanza/sites/default/files/civicrm/templates_c//mail.log' );
// }
